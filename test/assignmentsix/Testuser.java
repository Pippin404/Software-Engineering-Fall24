...
public class Testuser {
    ...
    // DONE 6.C.3: change the type of this variable to the name you're using for
    // your
    // User <-> ComputeEngine API; also update the parameter passed to the
    // constructor DONE
    // Pippin Notes: There isn't a toString function or anything. I wonder how our
    // code is going to integrate with this
